...
public class InMemoryRepoImp implements Repo {
    ...
    private void init() {
        ...
        create(new Note("Title 17", "Description 17"));
        create(new Note("Title 18", "Description 18"));
        create(new Note("Title 19", "Description 19"));
        create(new Note("Title 20", "Description 20"));
    }
